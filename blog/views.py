...
def index(request):
    ...
    most_popular_posts_id = [post.id for post in most_popular_posts]
    posts_with_comments = Post.objects.filter(id__in=most_popular_posts_id).annotate(comments_count=Count('comments'))
